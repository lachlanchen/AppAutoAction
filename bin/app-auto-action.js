...
console.error(
  "AppAutoAction requires Python 3.10+. Set APPAUTOACTION_PYTHON to a Python executable if python3 is not on PATH."
);
if (lastError && process.env.APPAUTOACTION_DEBUG) {
