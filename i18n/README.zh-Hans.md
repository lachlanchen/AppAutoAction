...
<p align="center">
  <img src="../docs/assets/appautoaction-vspice-studio.png" alt="AppAutoAction Studio 展示 V-SPICE 任务以及 Blender/OpenSCAD 产物" width="1100">
</p>

## 项目用途

AppAutoAction 为 Codex、AgInTiFlow、Claude 和其他 MCP 感知智能体提供一个实用的应用自动化控制面。它把目标工具放入清晰的注册表，验证配置，并把可审查的 JSON 信封发送给正确的适配器。
