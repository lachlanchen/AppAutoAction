...
<p align="center">
  <img src="../docs/assets/appautoaction-vspice-studio.png" alt="AppAutoAction Studio 展示 V-SPICE 任務以及 Blender/OpenSCAD 產物" width="1100">
</p>

## 專案用途

AppAutoAction 為 Codex、AgInTiFlow、Claude 和其他 MCP 感知智慧體提供一個實用的應用自動化控制面。它把目標工具放入清晰的註冊表，驗證設定，並把可審查的 JSON 信封送到正確的適配器。
